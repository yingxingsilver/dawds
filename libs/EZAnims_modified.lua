...
or (ob.climbing.active and next(ob.climbing.list)==nil)
or (ob.swimming.active and next(ob.swimming.list)==nil)
or (ob.elytra.active and next(ob.elytra.list)==nil)
or (ob.jumpingup.active and next(ob.jumpingup.list)==nil)
...
models.model.Player.root.Torso.RightArm1.RightArm.RightItemPivot:setPos(0, 0,-1.2)
elseif rightItem.id:find("bow") then
models.model.Player.root.Torso.RightArm1.RightArm.RightItemPivot:setPos(-0.5, 0, 0)
else
...
models.model.Player.root.Torso.LeftArm1.LeftArm.LeftItemPivot:setPos(0, 0,-1.2)
elseif leftItem.id:find("bow") then
models.model.Player.root.Torso.LeftArm1.LeftArm.LeftItemPivot:setPos(0.5, 0, 0)
else
